...
//   const stats: Stat[] = [
//     { label: 'Total Conversations', value: '1,234', change: '+12%', color: 'blue', icon: MessageCircle },
//     { label: 'Active Chats', value: '89', change: '+5%', color: 'green', icon: Zap },
//     { label: 'AI Responses', value: '456', change: '+23%', color: 'purple', icon: Bot },
//     { label: 'Response Time', value: '2.3s', change: '-8%', color: 'orange', icon: Clock }
//   ];
...
//           </div>
//           <div className="h-64 flex items-center justify-center text-gray-400 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl">
...
//                 <p className="text-sm text-gray-700">New conversation started with <span className="font-semibold">Customer {i}</span></p>
