...
export const ChatModule: React.FC<ChatModuleProps> = ({ isMobile }) => {
  ...
  useEffect(() => {
    ...
    wsConversations.current.onopen = () => console.log("Conversations WebSocket Connected");
    wsConversations.current.onclose = () => console.log("Conversations WebSocket Disconnected");
    wsConversations.current.onerror = (err) => console.error("Conversations WS Error:", err);
            ...
            <div className="flex items-start gap-3">
              <div className="relative flex-shrink-0">
                ...
                <div className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-2 border-white ${
                  conversation.current_handler_type === 'ai' ? 'bg-purple-500' : 'bg-emerald-500'
      ...
      <div className="p-4 border-b border-gray-100 bg-white shadow-sm">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-gray-900 text-lg">{selectedConversation.customer_name}</div>
